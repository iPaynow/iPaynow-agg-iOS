...
/* --  四要素验证 -- */
BLightApp.callCoreElements = function(sucessFn,failFn,options)
{
    sucessFn = encodeURIComponent(encodeURIComponent(sucessFn || ''));
    failFn = encodeURIComponent(encodeURIComponent(failFn || ''));
    options = encodeURIComponent(encodeURIComponent(options || ''));
    ...
    window.bba_la_node.invoke('callCoreElements?', params, onSuccess, onFail, '');
};

/* --  声纹能力 -- */
BLightApp.callSpeaRecog = function(sucessFn,failFn,options)
{
    sucessFn = encodeURIComponent(encodeURIComponent(sucessFn || ''));
    failFn = encodeURIComponent(encodeURIComponent(failFn || ''));
    options = encodeURIComponent(encodeURIComponent(options || ''));
    ...
    window.bba_la_node.invoke('callSpeaRecog?', params, onSuccess, onFail, '');
};
...
BLightApp.callQRCodeScanner = function(options,sucessFn,failFn)
{
    ...
    window.bba_la_node.invoke('doScanBarCode?', params, onSuccess, onFail, '');
};
