...
#define SAPI_CHECKBOX_BG @"checkbox"
#define SAPI_CHECKBOX_BG_HL @"checkbox_hl"

//404页面
#define PAGE_NOT_FOUND                            @"sapi_404"

#define BINGO_LOGO @"bingo"
#define ALERT_LOGO @"alert"
#define VOICE_MICROPHONE @"microphone"
#define VOICE_SWIPE_UP_LOGO @"voice_swipe_up_logo"

#define VOICE_BTN_LOGO @"voice_btn_logo"

#define VOICE_STATUS_BAR_0 @"voice_status_bar_0"
#define VOICE_STATUS_BAR_1 @"voice_status_bar_1"
#define VOICE_STATUS_BAR_2 @"voice_status_bar_2"

#define SAPI_LOGIN_USER_INPUT_ICON @"login_input_user_icon"
