#
#  Be sure to run `pod spec lint ipaynowplugin.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Hstripe"
  # s.authors            = { "Hstripe" => "hrbistu@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Hstripe"
