...
- (void)viewDidLoad{
    [super viewDidLoad];
    _scrollView.contentSize=CGSizeMake(277, 500);
...
- (IBAction)baiduWalletClick:(id)sender {
    [self payByType:@"61"];
}

- (IBAction)qqWalletPayClick:(id)sender
{
    [self payByType:@"25"];
}
...
- (void)payByLocalSign{
    ...
    [IpaynowPluginApi pay:payData AndScheme:@"IpayNowMarket" viewController:self delegate:self];
}
